...
<?php 
 ...
 $nhan=$_GET['idvd'];
$list=mysql_query("select * from video where video.idvd='".$nhan."'");
...
<div class="phatvideo">
<div class="tenvideo"><h2>Đang Phát:<?php echo $ma[1];?>  -  <?php echo $san[2];?> <?php 
$qwer=$ma[6]+1;mysql_query("update video set luotnghe='".$qwer."' where idvd='".$ma[0]."'");
echo " - lượt xem: ".++$ma[6];?></h2></div>
</pre><br><br><center><video width="685" height="380" background=#fff controls autoplay>
...
<div class="vdeo"><div class="videolq"><!--class vd lien quan--!>
<?php
 $sw=$san[0];                   
...
<div class="content-item"><!--class video--!>
    ...
    <a href="video.php?idvd=<?php echo $a['idvd'] ;?>"><?php echo $a['tenvd']; ?></a>
