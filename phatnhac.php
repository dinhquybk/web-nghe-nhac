...
<div class="phatnhac">
<div class="tenbaihat"><h2>Đang Phát:<?php echo $ma[1];?>  -  <?php echo $san[2];?> <?php echo " - lượt nghe".$ma[5];?></h2></div>
</pre><br><br><center><video width="600" height="1" background=#fff controls>
...
<?php echo $san[7]?> 
    ...
    <div class="Baihatnoi">
<center>
    <h4 class="content-block-title"><a title"bài hát nổi bật" href="baihat.html">Bài hát nổi bật</a></h4>
    </center>
   <ul>
  ...
  <li>
    <div class="nhac-item">
    <a title="Đắng Lòng Thanh Niên" href="">Đắng Lòng Thanh Niên</a>
  ...
  <li>
    <div class="nhac-item">
    <a title="Bâng Khuâng" href="">Bâng Khâng</a>
